...
def createExample():
    ...
    am.createFilledGapFace(line1Face, 4,
                           [{"id": uuid.uuid4(), "x_pos": 1.25, "y_pos": 0.5}, {"id": 10, "x_pos": 1.25, "y_pos": 2.0},
                            {"id": 11, "x_pos": 1.75, "y_pos": 2.0}, {"id": 12, "x_pos": 1.75, "y_pos": 0.5}], "Tree")
    am.createFilledGapFace(line1Face, 4,
                           [{"id": 17, "x_pos": 0.25, "y_pos": 0.5}, {"id": 18, "x_pos": 0.25, "y_pos": 2.0},
    ...
    am_growth.createFilledGapFace(line1, 4, [{"id": uuid.uuid4(), "x_pos": 1.25, "y_pos": 0.5},
                                             {"id": 10, "x_pos": 1.25, "y_pos": 2.0},
                                             {"id": 11, "x_pos": 1.75, "y_pos": 2.0},
                                             {"id": 12, "x_pos": 1.75, "y_pos": 0.5}], "Tree")
    am_growth.createFilledGapFace(line1, 4,
                                  [{"id": 17, "x_pos": 0.25, "y_pos": 0.5}, {"id": 18, "x_pos": 0.25, "y_pos": 2.0},
                                   {"id": 19, "x_pos": 0.75, "y_pos": 2.0}, {"id": 20, "x_pos": 0.75, "y_pos": 0.5}],
                                  "Tree")
    ...
    line2Face = am_growth.createFace(4, [{"id": 13, "x_pos": 2.0, "y_pos": 6.0}, {"id": 14, "x_pos": 0.0, "y_pos": 6.0},
                                         {"id": 15, "x_pos": 0.0, "y_pos": 9.0},
                                         {"id": 16, "x_pos": 2.0, "y_pos": 9.0}])
...
def ExampleParsing():
    path = ".\\DatasTests/06-02-2023 075833.txt"
    am = nMap()
    am = Parse(path, am)
